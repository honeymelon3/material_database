     ...
     if (req.file != null) {
         ...
         exec(commands_string, function (error, stdout, stderr) {
             ...
             my_conn.query(sql, function (result) {
                 ...
                 var sql = 'copy alloy_param_data(alloy_grade,test_temp,effect_factor1_value,effect_factor1_name,effect_factor2_value,effect_factor2_name,standard_id,param_id,report_id,test_stress,material_source,material_name,test_time,test_duration,test_org,effect_factor3_value,effect_factor3_name,db_type,note,alloy_spec.No,alloy_type/grade,effect_factor4_value,effect_factor4_name,fracture_profile,creep_curve,metallograph,param_value,effect_factor_name,effect_factor_value,alloy_batch_id,alloy_shape_id,test_direction_id,data_category) from \'' + req.file.path + '\' with delimiter as \',\' csv header;';
                 console.log(sql);
                 my_conn.query(sql, function (result) {
